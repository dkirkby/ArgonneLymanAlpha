...
if 1 :
    bins=np.linspace(1.-0.125,3.5+0.125,12)
    ...
    a0.errorbar(nodes[h1>1],mean[h1>1],rms[h1>1],fmt="o",color="red",lw=4)
    a0.errorbar(nodes[h1>1],mean[h1>1],err[h1>1],fmt="o",color="k",lw=4)
...
if 1 :
    ...
    err=rms/(h1-1)
    nodes=bins[:-1]+(bins[1]-bins[0])/2.
    a1.errorbar(nodes[h1>1],mean[h1>1],rms[h1>1],fmt="o",color="red",lw=4)
    a1.errorbar(nodes[h1>1],mean[h1>1],err[h1>1],fmt="o",color="k",lw=4)
